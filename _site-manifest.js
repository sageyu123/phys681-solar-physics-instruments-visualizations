window.PHYS681_SITE_MANIFEST = {
  ...
  "pages": [
    {
      "filename": "emission-mechanism-explorer-narratives.html",
    ...
    {
      "filename": "specific-intensity-flux-density.html",
      ...
      "expected_minutes": 12,
      "narrative_anchor": "emission-mechanism-explorer-narratives.html#specific-intensity-and-flux-density-explorer",
      "dependencies": [],
      "status": "release",
    ...
    {
      "filename": "radio-transfer-mechanisms.html",
      ...
      "expected_minutes": 15,
      "narrative_anchor": "emission-mechanism-explorer-narratives.html#radio-transfer-mechanisms-explorer",
      "dependencies": [],
      "status": "release",
    ...
    {
      "filename": "magnetoionic-propagation.html",
      ...
      "expected_minutes": 18,
      "narrative_anchor": "emission-mechanism-explorer-narratives.html#magnetoionic-propagation-explorer",
      "dependencies": [],
      "status": "release",
    ...
    {
      "filename": "bremsstrahlung-explorer.html",
      ...
      "expected_minutes": 20,
      "narrative_anchor": "emission-mechanism-explorer-narratives.html#bremsstrahlung-explorer",
      "dependencies": [],
      "status": "release",
    ...
    {
      "filename": "gyro-emission-explorer.html",
      ...
      "expected_minutes": 25,
      "narrative_anchor": "emission-mechanism-explorer-narratives.html#gyro-emission-explorer",
      "dependencies": [],
      "status": "release",
    ...
    {
      "filename": "plasma-emission-explorer.html",
      ...
      "expected_minutes": 30,
      "narrative_anchor": "emission-mechanism-explorer-narratives.html#plasma-emission-explorer",
      "dependencies": [],
      "status": "release",
    ...
    {
      "filename": "plasma-radiation-conversion-map.html",
      ...
      "expected_minutes": 15,
      "narrative_anchor": "emission-mechanism-explorer-narratives.html#plasma-radiation-conversion-map-and-companion-pages",
      "dependencies": [
    ...
    {
      "filename": "plasma-fundamental-conversion.html",
      ...
      "expected_minutes": 12,
      "narrative_anchor": "emission-mechanism-explorer-narratives.html#scattering-mode-conversion",
      "dependencies": [
        "plasma-conversion-shared.css"
      ],
      "status": "release",
    ...
    {
      "filename": "plasma-backscattering-decay.html",
      ...
      "expected_minutes": 12,
      "narrative_anchor": "emission-mechanism-explorer-narratives.html#backscattering-decay",
      "dependencies": [
        "plasma-conversion-shared.css"
      ],
      "status": "release",
    ...
    {
      "filename": "plasma-harmonic-coalescence.html",
      ...
      "expected_minutes": 12,
      "narrative_anchor": "emission-mechanism-explorer-narratives.html#langmuir-wave-coalescence",
      "dependencies": [
        "plasma-conversion-shared.css"
      ],
      "status": "release",
    ...
    {
      "filename": "ecm-emission-explorer.html",
      ...
      "expected_minutes": 25,
      "narrative_anchor": "emission-mechanism-explorer-narratives.html#ecm-emission-explorer",
      "dependencies": [],
      "status": "release",
    ...
    {
      "filename": "radio_interferometry_fundamentals.html",
    ...
    {
      "filename": "fourier-interferometry.html",
    ...
    {
      "filename": "fourier-synthesis-gallery.html",
    ...
    {
      "filename": "radio-interferometric-image-reconstruction.html",
    ...
    {
      "filename": "polarization-ellipse-interactive.html",
    ...
    {
      "filename": "zeeman-components-illustration.html",
    ...
    {
      "filename": "receiver-noise-interactive.html",
    ...
    {
      "filename": "beam-pattern-feed-illumination.html",
    ...
    {
      "filename": "aperture-blockage-efficiency.html",
    ...
    {
      "filename": "delay_pattern_interactive.html",
    ...
    {
      "filename": "eovsa-frequency-tuning-explainer.html",
    ...
    {
      "filename": "corner_turn_visualization.html",
    ...
    {
      "filename": "eovsa-adc-demux-explainer.html",
    ...
    {
      "filename": "fasr_mutual_coupling_diagnostics.html",
